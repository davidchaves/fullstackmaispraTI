...
//A estrutura for in itera sobre os índices de um objeto iterável, enquanto for of itera sobre os valores do objeto iterável.
...
let veiculoES6 = {
	...
	exibirDetalhes() {
		console.log(
			`${this.fabricante}, ano ${this.ano}, cor ${this.cor}, tipo ${this.tipo}`
		);
	},
};
